...
#export avg LD tsv
write.table(avgLD, "CALLnonnmt_avgd-prime.tsv", row.names = F, sep = '\t',
            col.names = T, quote = F)
...
ggsave("CALLnonnmt_avgd-prime.pdf", p1, width = 7, height = 4)
...
write.table(top1, "CALLnonnmt_topOnePercentDPrime.tsv", row.names = F, sep = '\t',
            col.names = T, quote = F)
...
write.table(top5, "CALLnonnmt_topFivePercentDPrime.tsv", row.names = F, sep = '\t',
            col.names = T, quote = F)
