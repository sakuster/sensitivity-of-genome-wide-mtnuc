...
#export avg LD tsv
write.table(avgLD, "CHAFnonnmt_avgr-squared.tsv", row.names = F, sep = '\t',
            col.names = T, quote = F)
...
ggsave("CHAFnonnmt_avgr-squared.pdf", p1, width = 7, height = 4)
...
write.table(top1, "CHAFnonnmt_topOnePercentRSquared.tsv", row.names = F, sep = '\t',
            col.names = T, quote = F)
...
write.table(top5, "CHAFnonnmt_topFivePercentRSquared.tsv", row.names = F, sep = '\t',
            col.names = T, quote = F)
