...
#export avg LD tsv
write.table(avgLD, "CHAFnonnmt_avgpcor.tsv", row.names = F, sep = '\t',
            col.names = T, quote = F)
...
ggsave("CHAFnonnmt_avgpcor.pdf", p1, width = 7, height = 4)
...
write.table(top1, "CHAFnonnmt_topOnePercentPcor.tsv", row.names = F, sep = '\t',
            col.names = T, quote = F)
...
write.table(top5, "CHAFnonnmt_topFivePercentPcor.tsv", row.names = F, sep = '\t',
            col.names = T, quote = F)
