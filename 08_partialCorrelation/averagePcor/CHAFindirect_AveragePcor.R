...
#export avg LD tsv
write.table(avgLD, "CHAFindirectnmt_avgpcor.tsv", row.names = F, sep = '\t',
            col.names = T, quote = F)
...
ggsave("CHAFindirectnmt_avgpcor.pdf", p1, width = 7, height = 4)
...
write.table(top1, "CHAFindirectnmt_topOnePercentPcor.tsv", row.names = F, sep = '\t',
            col.names = T, quote = F)
...
write.table(top5, "CHAFindirectnmt_topFivePercentPcor.tsv", row.names = F, sep = '\t',
            col.names = T, quote = F)
