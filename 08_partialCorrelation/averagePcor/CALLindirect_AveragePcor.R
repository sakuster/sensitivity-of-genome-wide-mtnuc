...
#export avg LD tsv
write.table(avgLD, "CALLindirectnmt_avgpcor.tsv", row.names = F, sep = '\t',
            col.names = T, quote = F)
...
ggsave("CALLindirectnmt_avgpcor.pdf", p1, width = 7, height = 4)
...
write.table(top1, "CALLindirectnmt_topOnePercentPcor.tsv", row.names = F, sep = '\t',
            col.names = T, quote = F)
...
write.table(top5, "CALLindirectnmt_topFivePercentPcor.tsv", row.names = F, sep = '\t',
            col.names = T, quote = F)
